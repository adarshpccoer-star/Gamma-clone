...
export default function page({ params }: { params: Promise<{ PresentationId: string }> }) { 
...
if (query.isError || !query.data) return <div>Error or Not Found...</div>;

const data = query.data;
const thumb = presentationThumbnailUrl(data.id); // This is now safe
